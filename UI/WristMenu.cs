...
namespace MalachiTemp.UI
{
    ...
    */
    ...
    {
        public static string MenuTitle = "CherechnyaMod"; // this is the menu name, you can change it to whatever you want
        ...
        public static List<ButtonInfo> buttons = new List<ButtonInfo> // main
        {
            ...
            new ButtonInfo { buttonText = "Movment", method =() => Mods.Cat1(), enabled = false, toolTip = "Go to Movment"},
            new ButtonInfo { buttonText = "SpeedBoosts", method =() => Mods.Cat2(), enabled = false, toolTip = "Go to speedboosts"},
            new ButtonInfo { buttonText = "Guns", method =() => Mods.Cat3(), enabled = false, toolTip = "Go to Guns"},
        ...
        {
            new ButtonInfo { buttonText = "Exit Movment", method =() => Mods.Cat1(), enabled = false, toolTip = "Go to Main!"},
        ...
        {
            new ButtonInfo { buttonText = "Exit Boosts", method =() => Mods.Cat2(), enabled = false, toolTip = "Go to Main!"},
            new ButtonInfo { buttonText = "Boost0", method =() => Mods.Speedboost0(), enabled = false, toolTip = "PLACEHOLDER!"},
            new ButtonInfo { buttonText = "boost1", method =() => Mods.Speedboost1(), enabled = false, toolTip = "PLACEHOLDER!"},
            new ButtonInfo { buttonText = "boost2", method =() => Mods.Speedboost2(), enabled = false, toolTip = "PLACEHOLDER!"},
        ...
        public static List<ButtonInfo> CatButtons3 = new List<ButtonInfo>
        {
            ...
            new ButtonInfo { buttonText = "Tag Gun", method =() => Mods.TagGun(), enabled = false, toolTip = "PLACEHOLDER!"},
        ...
        {
            "this is the CherechnyaMod motd", // motd title
            "this is the CherechnyaMod coc", // coc title
            "this is the CherechnyaMod coc description", // coc description
            "this is the CherechnyaMod motd description" // motd description
        };
        ...
        // Определяем кастомный синий цвет #008cff
        private static Color _customBlueColor = new Color(0f, 0.549f, 1f, 1f); // #008cff в RGB (0, 140, 255)

        public static Color FirstColor = Color.blue; // if changingcolors is true, this is the main first color the menu will be
        public static Color SecondColor = _customBlueColor; // if changingcolors is true, this is the main second color the menu will be. Now it's #008cff
        ...
        void Update()
        {
            try
            {
                ...
                if (custom)
                {
                    ...
                    // Изменение цвета монитора на #008cff
                    Color customBlue;
                    if (ColorUtility.TryParseHtmlString("#008cff", out customBlue))
                    {
                        // Меняем цвет монитора
                        GameObject monitor = GameObject.Find("Environment Objects/LocalObjects_Prefab/TreeRoom/TreeRoomInteractables/GorillaComputerObject/ComputerUI/monitor/");
                        if (monitor != null)
                        {
                            Renderer monitorRenderer = monitor.GetComponent<Renderer>();
                            if (monitorRenderer != null)
                            {
                                monitorRenderer.material.color = customBlue;
                            }
                        }

                        // Меняем цвет клавиатуры
                        ...
                        if (keyboard != null)
                        {
                            ...
                            {
                                keyboardRenderer.material.color = customBlue;
                            }
                        }
                    }
